...
export const generateCertificate = async (
  ...
  try {
    ...
    res.setHeader(
      'Content-Disposition',
      `attachment; filename="nepal360-certificate-${donationId}.pdf"`
    );
    ...
    doc
      ...
      .font('Helvetica')
      .text(
        `For the generous donation of ${amount}`,
        0,
        275,
        { align: 'center' }
      );
    ...
    // Date of donation
    const donationDate = format(new Date(donation.createdAt), 'MMMM dd, yyyy');
    doc
      .fontSize(12)
      .fillColor('#6b7280')
      .font('Helvetica')
    ...
    doc
      ...
      .text(
        'Your generosity makes a real difference. Thank you for being a part of Nepal360.',
        0,
        435,
        { align: 'center' }
      );
