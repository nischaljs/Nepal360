...
exports.predictCampaignSuccess = predictCampaignSuccess;
exports.predictExistingCampaign = predictExistingCampaign;
const FACTORS = {
...
function scoreDescriptionLength(description) {
    ...
    if (wordCount >= 100 && wordCount <= 1500)
        return 0.7;
    if (wordCount < 100)
        return Math.max(0.3, wordCount / 100);
    return Math.max(0.3, 1 - (wordCount - 1000) / 1000);
}
function scoreTargetAmount(amount, category) {
    if (!amount || amount <= 0)
        return 0.5;
    ...
    const average = categoryAverages[(category === null || category === void 0 ? void 0 : category.toLowerCase()) || ''] || 500000;
...
function getCategoryStrengthScore(category) {
    ...
    return categorySuccessRates[(category === null || category === void 0 ? void 0 : category.toLowerCase()) || ''] || 0.6;
}
function predictCampaignSuccess(input, prisma) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (input.beneficiaryId) {
            ...
            if (campaigns.length > 0) {
                const successfulCampaigns = campaigns.filter(c => c.status === 'COMPLETED' || (c.donationCount > 10)).length;
...
function predictExistingCampaign(campaignId, prisma) {
    return __awaiter(this, void 0, void 0, function* () {
