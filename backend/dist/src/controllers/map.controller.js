...
exports.getCampaignMapData = exports.getDistrictList = void 0;
...
const getDistrictList = (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    res.json({ success: true, data: Object.keys(DISTRICT_COORDS).sort() });
});
exports.getDistrictList = getDistrictList;
const getCampaignMapData = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.getCampaignMapData = getCampaignMapData;
