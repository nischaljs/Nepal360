...
router.post('/money/khalti/initiate', auth_middleware_1.requireAuth, (0, errohandler_middleware_1.catchAsync)(donation_controller_1.initiateKhaltiPayment));
router.post('/money/khalti/verify', auth_middleware_1.requireAuth, (0, errohandler_middleware_1.catchAsync)(donation_controller_1.verifyKhaltiPayment));
