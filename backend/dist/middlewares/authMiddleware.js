...
function requireAdmin(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const adminRole = yield prisma.adminRole.findUnique({ where: { userId: user.userId } });
            if (!adminRole) {
...
function requireApprovedKYC(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const kycProfile = yield prisma.kycProfile.findUnique({ where: { userId: user.userId } });
            if (!kycProfile || kycProfile.status !== client_1.KYCStatus.APPROVED) {
